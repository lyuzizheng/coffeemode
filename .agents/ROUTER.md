...
| --- | --- | --- |
| Take a feature/fix from idea to merged PR (closed loop), 实现, 修复 | [implementation-cycle](./skills/coffeemode-implementation-cycle/SKILL.md) | [development-cycle](./workflows/development-cycle.md) |
| File an issue, report a bug, 提交 issue, 报告 bug | [issue-submission](./skills/coffeemode-issue-submission/SKILL.md) | — (see `docs/agent/issue-guidelines.md`) |
| Pick up / triage / fix an existing GitHub issue, 处理 issue | [issue-review-fix](./skills/coffeemode-issue-review-fix/SKILL.md) | [development-cycle](./workflows/development-cycle.md) |
...
| Orientation, status, plan, resolve doc conflicts, 进度 | [docs-orientation](./skills/coffeemode-docs-orientation/SKILL.md) | — (see `docs/agent/reading-order.md`) |
