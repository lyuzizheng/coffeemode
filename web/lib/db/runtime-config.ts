...
import { isBannerLive, isRuntimeBanner } from "@/lib/runtime-banners";
import type { RuntimeConfig } from "@/types/runtime-config";

/**
 * Runtime operator content reader (BRAWUKA-284): announcement banners
 * readable without a redeploy. Build-time parameters stay in
...
const RUNTIME_CONFIG_KEYS = ["banners"] as const;
