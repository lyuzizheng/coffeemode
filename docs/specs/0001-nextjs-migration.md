...
#### Tables (7 total: 6 product + 1 infra — deliberately minimal; applied via migrations 0001–0030)
...
create table cafes (
  ...
  apple_poi_id    text,
  source          text not null default 'user_confirmed', -- 0030: 用户确认提交，含 Google 预填 (BRAWUKA-620)
