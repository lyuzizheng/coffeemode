...
由 `scripts/check-file-size.mjs` 读取。`checkin-drawer.tsx`（730，守卫合入前 main 上 BRAWUKA-185 (#358) 造成的 +5）已由 BRAWUKA-197 (#370) 拆分毕业；`checkin-feed` 的 440 是 BRAWUKA-73 (#349) 造成的 +1，
