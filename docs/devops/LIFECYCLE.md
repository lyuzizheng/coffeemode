...
2. `application-static` + `application-e2e` (parallel): typecheck, ESLint, i18n key parity, structure guard, standalone build, bundle budget audit; Playwright E2E smoke + Lighthouse CI budgets. Unit tests retired (BRAWUKA-682).
