...
| discovery-sheet | Responsive discovery core + swipe cards + URL sync | BLOCKED | 0001, 0002 | design-tokens, work-profile | Kimi K3 discovery design artifact; Helpful ranking formula and cursor tie-breakers | typecheck, unit, integration, build, e2e, visual | Mobile PEEK/HALF/FULL and desktop sidebar/detail drawer share selection + one-push/then-replace URL state; real public-safe CafeSummary/detail/check-in DTOs, Helpful/Newest cursor feeds, no MapKit or SSR-route ownership (#133) |
