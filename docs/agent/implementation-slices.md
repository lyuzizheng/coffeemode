...
| places-proxy | Next.js /api/places/* route handlers proxying the POI service | IN-PROGRESS | 0001 | poi-cache-service | none | typecheck, unit, build | Server-side POI client + search/resolve routes; Google key never in web/ |
