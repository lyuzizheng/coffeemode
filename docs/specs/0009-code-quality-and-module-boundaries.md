...
已由 BRAWUKA-73 (#361) 在 main 上压到 433（BRAWUKA-200 同步登记值），
随后由 BRAWUKA-198 (#368) 拆分为 `use-checkin-feed.ts` + `feed-card.tsx` + 薄壳并毕业；`config-schema.ts` 是 BRAWUKA-184 (#357) 引入；基线自记录值起只降不升。
